...
class _QRScannerScreenState extends State<QRScannerScreen> {
		...
		await showDialog<void>(
			...
			builder: (context) {
				return StatefulBuilder(builder: (context, setStateDialog) {
					return AlertDialog(
						title: Text(scanned ? 'Detalles de la Reserva' : 'Escanear Código QR'),
						content: SizedBox(
							width: 300,
							child: scanned
									? Column(
									...
									: Column(
											...
											children: [
												...
												const Text('Presiona iniciar para simular el escaneo.'),
											],
										),
						),
						actions: scanned
											...
											ElevatedButton(
												onPressed: () {
													...
													ScaffoldMessenger.of(context).showSnackBar(
														const SnackBar(content: Text('Entrada validada correctamente')),
													);
												},
	...
	Future<void> _showRatingDialog(BuildContext context, Booking booking, Participant participant) async {
						...
						actions: [
							...
							ElevatedButton(
								onPressed: () {
									...
									Navigator.of(context).pop();
									ScaffoldMessenger.of(context).showSnackBar(
										SnackBar(content: Text('Calificación de $rating estrellas guardada para ${participant.name}')),
									);
								},
									...
									child: Column(
										...
										children: [
											...
											Wrap(
												spacing: 8,
												children: [
													Text(booking.courtName, style: const TextStyle(color: Colors.grey)),
													const Text('•', style: TextStyle(color: Colors.grey)),
													Text(booking.date, style: const TextStyle(color: Colors.grey)),
													const Text('•', style: TextStyle(color: Colors.grey)),
													Text(booking.time, style: const TextStyle(color: Colors.grey)),
													const Text('•', style: TextStyle(color: Colors.grey)),
													Chip(label: Text(booking.status)),
												],
											),
									...
									secondChild: Container(
										...
										child: Column(
											...
											children: [
												...
												const SizedBox(height: 8),
												...booking.participants.map((p) => Padding(
															...
															child: Row(
																children: [
																	...
																	ElevatedButton(
																		onPressed: () => _showRatingDialog(context, booking, p),
																		style: ElevatedButton.styleFrom(
																			backgroundColor: AppColors.primary500, // app primary for contrast
																		),
				...
				child: Column(
					...
					children: [
						const Padding(
							...
							child: Text('Bienvenido controlador', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
						),
						Expanded(
							child: ListView(
